...
Xtest = list(test.columns.values)[2:6744]
...
alg = RandomForestClassifier(random_state=1, n_estimators=92, min_samples_split=2, min_samples_leaf=1)
...
File = open("data/prob92.txt", "w",encoding=u'utf-8', errors='ignore')
File.write("ID"+",")
File.write("prob" + "\n")
...
#scores.mean= 0.9040360798497216  n_estimators=62
#scores.mean= 0.9044962626438823    n_estimators=92
