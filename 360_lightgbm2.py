...
alg = lgb.LGBMClassifier(boosting_type='gbdt', num_leaves=32, max_depth=9, learning_rate=0.001, n_estimators=120,
...
File = open("data/prob_lgb1025.txt", "w",encoding=u'utf-8', errors='ignore')
File.write("id"+"," + "prob" + "\n")
...
#scores.mean= 0.8270048067188507  n_splits=120 num_leaves=90  n_estimators=100  test[Xtest]
