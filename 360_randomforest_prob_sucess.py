...
alg = RandomForestClassifier(random_state=142857, n_estimators=62, min_samples_split=2, min_samples_leaf=1, nthreads=-1)
...
File = open("data/prob-randomforest.txt", "w",encoding=u'utf-8', errors='ignore')
File.write("id"+"," + "prob" + "\n")
